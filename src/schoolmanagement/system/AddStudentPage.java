...
public class AddStudentPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Heading.setText("ADD NEW STUDENT");
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try{
            ...
            try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/sms","root","2202")) {
                ...
                ptstmt.setString(1, rollno.getText());
                ptstmt.setString(2, name.getText());
                ptstmt.setString(3, fathername.getText());
                ptstmt.setString(4, mothername.getText());
